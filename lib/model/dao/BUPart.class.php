<?php
	/**
	 * Class for Busway part. Primary responsiblity is to allow
	...
	class BUPart extends Part {
		...
		public function getPageTitle() {
			...
			return "{$this->_part_no} {$sep} Busway {$sep} {$this->_details['manuf']} | {$branding}";
		}
		...
		public function getMetaKeywords() {
			return 'busplugs,bus plugs,bus duct,busway systems,bus way systems,busduct,new,used,reconditioned,1-year warranty,discounted shipping,quick turnaround';
		}
