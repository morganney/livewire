...
<?php use_stylesheet('home_test') ?>
<?php use_javascript('jquery.cycle.lite.js') ?>
<?php use_javascript('h_test') ?>
...
<div id='slideshow'>
	<ul id='slides'>
		...
		<li id='slide_2'>
			<div class='slide_text'>
				<h2>Massive Inventory &amp; National Distribution Network</h2>
	...
	<form id='stock_search' class='module' name='stock_search' method='get' action='<?php echo url_for('@part_search') ?>'>
		...
		<div id='product_categories'>
			...
			<ul id='categories'>
				...
				<li id='transformers' class='right'><h3><?php echo link_to('TRANSFORMERS', '@transformers', array('title' => '')) ?></h3></li>
