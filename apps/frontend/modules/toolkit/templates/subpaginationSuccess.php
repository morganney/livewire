...
<?php include_partial('global/h1', array('txt' => "{$param['manuf']} {$param['category']} {$param['section']} {$param['subcategory']} ({$param['current_page_num']} of {$param['total_pages']})", 'hide_phone_num' => true)) ?>
...
<?php 
	echo link_to("{$param['manuf']} {$param['section']} {$param['subcategory']} ({$param['next_page_num']} of {$param['total_pages']})", 
	'@sub_pagination?cat_slug=' . $sf_params->get('cat_slug')
	. '&manuf_slug=' . $sf_params->get('manuf_slug')
	. '&subcat_slug=' . $sf_params->get('subcat_slug')
	. '&section=' . $sf_params->get('section')
