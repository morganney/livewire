	...
	<div class='step four'><img id='indy_1st' src='/images/industry-first-trans.png' alt="Industry's first transformer selection tool" /></div>
	<div id='step'>
	  <p id='ajax_back'><?php echo link_to(image_tag('arrow-back.png', array('alt' => 'Go Back')),'@tr_select', array('class' => 'ajax', 'query_string' => $back_qs)) ?></p>
		<h2 class='four'>Select Your Output(Secondary) Voltage <img id='tooltip' src='/images/help.png' alt='Voltage Help' /></h2>
