	...
	<?php if($id % 2 != 0) : ?>
	 ...
	 <?php endif; ?>
		...
		<div class='item_price'>
			<p class='new_price'><strong><script type='text/javascript' src='http://shopping.netsuite.com/app/site/query/getitemprice.nl?c=502106&amp;id=<?php echo $arr['ns_new_id'] ?  $arr['ns_new_id'] : 'xyz'; ?>'></script></strong>Guaranteed Price</p>
	 		<p><strong><script type='text/javascript' src='http://shopping.netsuite.com/app/site/query/getitemprice.nl?c=502106&amp;id=<?php echo $arr['ns_green_id'] ?  $arr['ns_green_id'] : 'xyz'; ?>'></script></strong> Certified Green </p>
		</div>
		<div class='buttons'>
		 	...
		 	<a class='btn _2' href='<?php echo url_for('@no_js') ?>' rel='nofollow' id='_<?php echo $arr['ns_green_id'] ?>' name='_<?php echo $arr['ns_green_id'] ?>'>Add to Cart</a>
		</div>
	</div>
	<?php endforeach; ?>
</div>
